							...
							<tr align="center">
								...
								<td>
									<div>
										...
										<a class="btn btn-sm btn-warning" href="{{ base_url('akun/pesanan_user/') . $p['kode_transaksi'] }}"><i class="fas fa-shopping-cart" title="Menu Yang Dipesan"></i></a>

										@if ($p['status_pemesanan'] == '2')
										<a class="btn btn-sm btn-danger" href="{{ base_url('akun/hapus_pesanan/') . $p['kode_transaksi'] }}" title="Hapus Pesanan"><i class="fas fa-trash-alt"></i></a>
										@endif
										
										
										@if ($p['nama_metode'] == 'menunggu pembayaran')

										<a class="btn btn-sm btn-success"
											href="{{ base_url('akun/proses_bayar/') . $p['kode_transaksi'] }}" title="Bayar"><i
												class="fas fa-cash-register"></i></a>

										@endif
										@if ($p['nama_metode'] == 'Rekening')

										<a class="btn btn-sm btn-success"
											href="{{ base_url('akun/bukti_pembayaran/') . $p['kode_transaksi'] }}" title="Kirim Bukti Pembayaran"><i
