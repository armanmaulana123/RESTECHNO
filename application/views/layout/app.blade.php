...
<head>
	...
	<script type="text/javascript" src="{{ base_url('vendor/sbadmin2/vendor/js/jquery.js') }}"></script>
	<script type="text/javascript" src="{{ base_url('vendor/sbadmin2/vendor/js/bootstrap.js') }}"></script>
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li>
							<a href="{{ base_url('akun/keranjang') }}" class="fas fa-shopping-cart fa-lg mt-4"></a>
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
								...
								<img class="img-profile rounded-circle"
									src="{{ base_url('assets/img/profile/user/') . $user['image'] }}">
							</a>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<a class="btn btn-primary" href="{{base_url('akun/logout')}}">Logout</a>
				</div>
			</div>
		</div>
	</div>
