<?php $__env->startSection('judul', 'Tambah Chef'); ?>
            ...
            <div class="col-lg-12">
                <div class="p-4 mb-4">
                    <div class="text-center">
                        ...
                        <form class="user" enctype="multipart/form-data" action="<?php echo e(base_url('akun/aksi_register_chef')); ?>" method="POST">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/register_chef.blade.php ENDPATH**/ ?>