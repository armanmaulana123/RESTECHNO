...
<form class="user" enctype="multipart/form-data" action="<?php echo e(base_url('auth/aksi_register_member')); ?>" method="POST">
...
<?php echo $__env->make('layout.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/register_member.blade.php ENDPATH**/ ?>