...
<?php $__env->startSection('judul', 'Pesanan Yang Sedang Diantar'); ?>
						...
						<tbody>
							...
							<tr align="center">
								...
								<td>
									...
									<div>
										<form action="<?php echo e(base_url('akun/selesai')); ?>" method="POST">
										<input type="hidden" name="kode_transaksi" value="<?php echo e($p['kode_transaksi']); ?>">
										<button type="submit" class="btn btn-sm btn-success"><i class="fas fa-check"></i>&nbspSelesai</button>
										</form>
									</div>
								</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/pesanan_diantar.blade.php ENDPATH**/ ?>