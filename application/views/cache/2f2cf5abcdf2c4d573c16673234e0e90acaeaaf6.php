					...
					<table class="table table-stripped" align="center" style="width:">
						...
						<tbody>
							...
							<tr align="center">
								...
								<td>
									<div>
										<a class="btn btn-sm btn-primary" href="javascript:void(0)" title="Detail"
											onclick="detail_pesanan('<?php echo e($p['kode_transaksi']); ?>')"><i
												class="fas fa-info-circle"></i></a>

										<a class="btn btn-sm btn-warning" href="<?php echo e(base_url('akun/pesanan_user/') . $p['kode_transaksi']); ?>"><i class="fas fa-shopping-cart" title="Menu Yang Dipesan"></i></a>

										<?php if($p['status_pemesanan'] == '2'): ?>
										<a class="btn btn-sm btn-danger" href="<?php echo e(base_url('akun/hapus_pesanan/') . $p['kode_transaksi']); ?>" title="Hapus Pesanan"><i class="fas fa-trash-alt"></i></a>
										<?php endif; ?>
										
										
										<?php if($p['nama_metode'] == 'menunggu pembayaran'): ?>

										<a class="btn btn-sm btn-success"
											href="<?php echo e(base_url('akun/proses_bayar/') . $p['kode_transaksi']); ?>" title="Bayar"><i
												class="fas fa-cash-register"></i></a>

										<?php endif; ?>
										<?php if($p['nama_metode'] == 'Rekening'): ?>

										<a class="btn btn-sm btn-success"
											href="<?php echo e(base_url('akun/bukti_pembayaran/') . $p['kode_transaksi']); ?>" title="Kirim Bukti Pembayaran"><i
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/data_pesanan_user.blade.php ENDPATH**/ ?>