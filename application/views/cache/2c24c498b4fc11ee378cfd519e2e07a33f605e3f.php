	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="card">
				...
				<img name="image_menu" src="<?php echo e(base_url('assets/img/daftar_menu/') . $m['image_menu']); ?>"
					class="card-img-top">
				<div class="card-body">
					...
					<div class="row text-right">
						<div><a href="<?php echo e(base_url('akun/hapus_menu/') . $m['id_menu']); ?>"
							class="btn btn-sm btn-danger">Hapus</a></div>&nbsp
						<div><a href="<?php echo e(base_url('akun/edit_menu/') . $m['id_menu']); ?>"
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/daftar_menu_admin.blade.php ENDPATH**/ ?>