			...
			<div class="col-lg-12">
				<div class="p-4 mb-4">
                    ...
                    <form action="<?php echo e(base_url('akun/buat_menu')); ?>" method="POST">
                        ...
                        <hr />
                        <div>
                            <a href="<?php echo e(base_url('akun/pesanan_dibuat')); ?>" class="btn btn-sm btn-danger"><i class="fas fa-chevron-left"></i></a>
                        </div>
                        <div class="text-right">
                            <?php if($detail_pesanan['status'] == 'Terkonfirmasi'): ?>
                            ...
                            <div class="text-right">
                                ...
                                <?php if($detail_pesanan['status'] == 'dibuat'): ?>
                            
                                <form action="<?php echo e(base_url('akun/selesai_dibuat')); ?>" method="POST">
                                    <input type="hidden" name="kode_transaksi" value="<?php echo e($pesanan['kode_transaksi']); ?>">
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/lihat_pesanan_chef.blade.php ENDPATH**/ ?>