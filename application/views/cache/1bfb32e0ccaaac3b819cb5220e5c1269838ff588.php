            ...
            <div class="col-lg-12">
                <div class="p-4 mb-4">
                    <div class="text-center">
                        ...
                        <form class="user" enctype="multipart/form-data" action="<?php echo e(base_url('akun/update_user')); ?>" method="POST">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/edit_user.blade.php ENDPATH**/ ?>