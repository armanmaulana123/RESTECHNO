<?php $__env->startSection('judul_halaman', 'Member'); ?>
...
<table border="0" class="table table-bordered table-hover mt-3" align="center">
	...
	<tbody>
		...
		<tr align="center">
			...
			<td>
				<a class="btn btn-sm btn-danger" href="<?php echo e(base_url('akun/hapus/') . $t['id_user']); ?>">Hapus</a>
				<a class="btn btn-sm btn-success" href="<?php echo e(base_url('akun/edit/') . $t['id_user']); ?>">Edit</a>
			</td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/data_member.blade.php ENDPATH**/ ?>