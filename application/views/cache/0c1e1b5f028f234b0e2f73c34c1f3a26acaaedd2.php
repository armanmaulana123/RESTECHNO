						...
						<tbody>
							...
							<tr align="center">
								...
								<td>
									...
									<a class="btn btn-sm btn-warning" href="<?php echo e(base_url('akun/pesanan/') . $p['kode_transaksi']); ?>" title="Menu Yang Dipesan"><i class="fas fa-shopping-cart text-light"></i></a>
									<?php if($p['status'] != 'belum dibayar'): ?>

									<?php if($p['nama_metode'] == 'Rekening'): ?>

									<a class="btn btn-sm btn-success"
										href="<?php echo e(base_url('akun/bukti_pembayaran_admin/') . $p['kode_transaksi']); ?>" title="Bukti Pembayaran"><i
											class="fas fa-file"></i></a>

									<?php endif; ?>
									
									<?php if($p['status'] == 'diproses'): ?>
									<?php if($p['nama_metode'] == 'Tunai'): ?>
									<form action="<?php echo e(base_url('akun/konfirmasi_pembayaran')); ?>" method="POST">
									<input type="hidden" name="kode_transaksi" value="<?php echo e($p['kode_transaksi']); ?>">
									<button type="submit" class="btn btn-sm btn-success"><i
											class="fas fa-check" title="Konfirmasi"></i></button>
									</form>
									<?php endif; ?>	
									<?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/data_pesanan_admin.blade.php ENDPATH**/ ?>