		...
		<div class="row">
			...
			<div class="col-lg-12">
				<div class="p-4 mb-4">
					...
					<hr />
					<div>
                    <form enctype="multipart/form-data" action="<?php echo e(base_url('akun/proses_bukti_pembayaran')); ?>" method="POST">
							<div class="row" style="margin-left: 50px;">
								...
								<div style="margin-left: 80px;">
									...
									<input type="text" name="total_bayar" class="form form-control"
										value="<?php echo e($detail_pesanan['total_bayar']); ?>" readonly required>
								</div>
								<div style="margin-left: 80px;">
									<label for="norek_tujuan">Nomor Rekening Tujuan : </label>
									<br />
									<label name="norek_tujuan"><img src="<?php echo e(base_url('assets/img/bank/bri.png')); ?>" style="width: 40px;"> :
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\restechno\application\views/bukti_pembayaran.blade.php ENDPATH**/ ?>