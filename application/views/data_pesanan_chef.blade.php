								...
								<td>
									<div>
										<a class="btn btn-sm btn-danger" href="javascript:void(0)" title="Detail"
											onclick="detail_pesanan('{{ $p['kode_transaksi'] }}')"><i
												class="fas fa-info-circle"></i>&nbspDetail</a>
                                        <a href="{{ base_url('akun/lihat_pesanan_chef/') . $p['kode_transaksi'] }}" class="btn btn-sm btn-success"><i class="fas fa-file"></i>&nbspLihat Pesanan</a>
									</div>
								</td>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a class="btn btn-primary" href="javascript:void(0)"
					onclick="detail_keranjang('{{ $p['kode_transaksi'] }}')">Data Keranjang</a>
			</div>
		</div>
	</div>
</div>
